...
background: linear-gradient(to top, #80ec75 0%,#43d034 100%); /* W3C */
border-radius: 120px;
...
background: linear-gradient(to top, #43d034 0%,#67e45c 100%); /* W3C */
}
...
background: linear-gradient(to top, #1d7d12 0%,#4fd342 100%); /* W3C */
}
</style>
